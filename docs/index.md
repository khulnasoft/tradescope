![tradescope](assets/tradescope_poweredby.svg)
...
<a class="github-button" href="https://github.com/khulnasoft/tradescope" data-icon="octicon-star" data-size="large" aria-label="Star khulnasoft/tradescope on GitHub">Star</a>
<a class="github-button" href="https://github.com/khulnasoft/tradescope/fork" data-icon="octicon-repo-forked" data-size="large" aria-label="Fork khulnasoft/tradescope on GitHub">Fork</a>
<a class="github-button" href="https://github.com/khulnasoft/tradescope/archive/stable.zip" data-icon="octicon-cloud-download" data-size="large" aria-label="Download khulnasoft/tradescope on GitHub">Download</a>
...
![tradescope screenshot](assets/tradescope-screenshot.png)
...
- Analyze: Further analysis can be performed on either Backtesting data or Tradescope trading history (SQL database), including automated standard plots, and methods to load the data into [interactive environments](data-analysis.md).
