"""
A Rest Client for Tradescope bot
...
class TsRestClient:
    ...
    def pair_history(self, pair, timeframe, strategy, timerange=None, tradeaimodel=None):
        """Return historic, analyzed dataframe

        :param pair: Pair to get data for
        :param timeframe: Only pairs with this timeframe available.
        :param strategy: Strategy to analyze and get values for
        :param tradeaimodel: TradeAI model to use for analysis
