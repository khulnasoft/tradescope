...
from tradescope.persistence.base import ModelBase
...
def test_init_custom_db_url(default_conf, tmp_path):
    ...
    filename = tmp_path / "tradescope2_test.sqlite"
...
def test_init_prod_db(default_conf, mocker):
    ...
    create_engine_mock = mocker.patch('tradescope.persistence.models.create_engine', MagicMock())
...
def test_init_dryrun_db(default_conf, tmpdir):
    filename = f"{tmpdir}/tradescope2_prod.sqlite"
...
def test_migrate(mocker, default_conf, fee, caplog):
    ...
    mocker.patch('tradescope.persistence.models.create_engine', lambda *args, **kwargs: engine)
