...
[![Documentation](https://readthedocs.org/projects/tradescope/badge/)](https://www.tscope-ui.vercel.app)
...
Please find the complete documentation on the [tradescope website](https://www.tscope-ui.vercel.app).
...
- [X] **Adaptive prediction modeling**: Build a smart strategy with TradeAI that self-trains to the market via adaptive machine learning methods. [Learn more](https://www.tscope-ui.vercel.app/en/stable/tradeai/)
- [x] **Edge position sizing** Calculate your win rate, risk reward ratio, the best stoploss and adjust your position size before taking a position for each specific market. [Learn more](https://www.tscope-ui.vercel.app/en/stable/edge/).
...
Please refer to the [Docker Quickstart documentation](https://www.tscope-ui.vercel.app/en/stable/docker_quickstart/) on how to get started quickly.

For further (native) installation methods, please refer to the [Installation documentation page](https://www.tscope-ui.vercel.app/en/stable/installation/).
...
Telegram is not mandatory. However, this is a great way to control your bot. More details and the full command list on the [documentation](https://www.tscope-ui.vercel.app/en/latest/telegram-usage/)
