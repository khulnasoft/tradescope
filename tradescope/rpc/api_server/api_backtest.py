...
from tradescope.types import get_BacktestResultType_default
...
def __run_backtest_bg(btconfig: Config):
    from tradescope.optimize.optimize_reports import generate_backtest_stats, store_backtest_stats
...
def api_get_backtest():
    ...
    """
    from tradescope.persistence import LocalTrade
    if ApiBG.bgtask_running:
        return {
            "status": "running",
            "running": True,
